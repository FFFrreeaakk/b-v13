...
client.on('ready', () => {
  console.log(`ArdaDemr: ${client.user.tag} isimli bot aktif!\nArdaDemr Youtube Kanalına Abone Olmayı Unutmayın!`);
});

client.on("messageCreate", async message => {
  
  if(message.content == `<@!${client.user.id}>`) message.channel.send("ArdaDemr Youtube Kanalına Abone Olmayı Unutmayın!");
